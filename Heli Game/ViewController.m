...
//  Heli Game
//
//  Created by Brian Wong on 12/24/15.
//  Copyright © 2015 BW. All rights reserved.
//
...
-(void)NewGame
{
    ...
    Heli.hidden = NO;
    Heli.center = CGPointMake(42,147);
...
-(void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    if (Start==YES)
    {
        ...
        Scorer = [NSTimer scheduledTimerWithTimeInterval:0.033 target:self selector:@selector(Scoring) userInfo:nil repeats:YES];
